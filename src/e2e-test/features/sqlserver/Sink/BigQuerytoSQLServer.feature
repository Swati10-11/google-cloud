@SQLServer_Sink
Feature:Verification of BigQuery to SQLServer Data Transfer

  @BQ_SOURCE_TEST @SQLServer_sink
  Scenario: To Verify data is getting transferred from BigQuery to SQLServer
    ...
    Then Connect source as "BigQuery" and sink as "SqlServer" to establish connection
